...
function CarmenLeavesSectorCallback()
	if ( gWorldSectorX == 9 and gWorldSectorY == SectorY.MAP_ROW_J and gWorldSectorZ == 0 ) then
		TriggerNPCRecord( Profil.CARMEN, 34 )
	elseif ( gWorldSectorX == 9 and gWorldSectorY == SectorY.MAP_ROW_J and gWorldSectorZ == 0 ) then
