...
MineType = { Silver = 0, Gold = 1, Platinum = 2, Gem = 3 }
...
function InitializeMines()
    ...
    local mines = 
	{
        -- Duranth (ex. San Mona)
        {
            Location = "K2", Type = MineType.Gold,
            MinimumProduction = 0,
            AssociatedUnderground = { "K1-1", "K2-1" },
        },

        -- LodenBurg (ex. Drassen)
        {
            Location = "J10", Type = MineType.Silver,
            MinimumProduction = 500,
            AssociatedUnderground = { "J10-1", "J11-1" },
            Infectible = 1,
        },

        -- Alaspar (ex. Alma)
        {
            Location = "D11", Type = MineType.Platinum,
            MinimumProduction = 2000,
            AssociatedUnderground = { "D11-1", "E11-1" },
            Infectible = 1,
        },

        -- Drasnia (ex. Cambria)
        {
            Location = "F14", Type = MineType.Gold,
            MinimumProduction = 1500,
            AssociatedUnderground = { "F14-1", "F15-1", "F16-1" },
            Infectible = 1,
        },

        -- Quevelin (ex. Chitzena)
        {
            Location = "O5", Type = MineType.Silver,
            MinimumProduction = 1000,
            AssociatedUnderground = { "O5-1", "O6-1" },
        },

        -- Aspenwood (ex. Grumm)
        {
            Location = "H5", Type = MineType.Gem,
            MinimumProduction = 3500,
            AssociatedUnderground = { "H5-1", "H4-1" },
            Infectible = 1,
        },
    }
